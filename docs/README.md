...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-06 21:18:11 UTC<br>状态：成功</p>
</section>
...
<p>今日仅速读1篇，主题聚焦EEG解码与辅助目标选择。</p>
<p>值得关注的是《EEG-VID》提出的任务引导潜伏预测预训练思路，但综合评分6.0，属于中等水平。</p>
<p>建议普通读者先将其作为背景了解，不必投入精读时间。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="EEG-VID: Task-Guided Latent Predictive Pretraining for EEG Decoding and Assistive Target Selection">EEG-VID: Task-Guided Latent Predictive Pretraining for EEG Decoding and Assistive Target Selection</span></li></ul>
  </div>
