...
date: 2026-03-23
pdf: "https://arxiv.org/pdf/2603.21682v2"
tags: ["query:gaze-intent"]
score: 7.0
evidence: 对话中的前瞻性话轮抢占与预测性编排
tldr: 针对语音助手交互僵硬的问题，本文提出 RESPOND 框架。该框架利用流式 ASR 和增量语义技术，使智能体能实现及时的反馈（如“嗯哼”）和主动的轮次抢占。其核心贡献在于提供了“反馈强度”和“抢占积极性”两个可调维度，使开发者能根据不同场景（如头脑风暴或心理咨询）定制交互风格，显著提升了语音交互的自然度和参与感。
selection_source: fresh_fetch
motivation: 现有的语音助手大多依赖“停顿-响应”模式，导致交互过程显得生硬且缺乏人性化的轮次切换。
method: 提出 RESPOND 框架，结合流式 ASR 和增量语义预测介入时机，并引入反馈强度与抢占积极性两个可调参数。
result: 该框架实现了流利且具备听者意识的对话，能够根据不同社交语境灵活调整智能体的交互行为。
conclusion: RESPOND 通过预测性编排与显式控制的结合，为开发更自然、更具参与感的语音界面提供了实用路径。
---
