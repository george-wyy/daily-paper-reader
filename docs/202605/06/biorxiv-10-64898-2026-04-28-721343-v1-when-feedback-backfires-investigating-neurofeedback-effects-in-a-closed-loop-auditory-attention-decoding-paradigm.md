...
score: 7.0
evidence: 闭环听觉注意力解码范式中的实时神经反馈
tldr: 本研究探讨了闭环神经反馈（NFB）对听觉注意力解码（AAD）的影响。通过对19名受试者在开环、听觉闭环、视觉闭环及伪听觉反馈四种条件下进行实验，发现听觉神经反馈在单次实验中不仅未能提升解码准确率，反而因增加认知负荷和分心导致性能下降。研究揭示了不稳定的反馈可能干扰学习过程，强调了开发更稳定解码器及长期训练协议对实现闭环AAD系统增益的重要性。
source: biorxiv
selection_source: fresh_fetch
motivation: 旨在探究实时神经反馈在闭环听觉注意力解码系统中对解码准确率和用户体验的短期影响。
method: 招募19名受试者，在开环、听觉增益反馈、视觉反馈和伪听觉反馈四种条件下执行选择性听力任务并进行在线与离线解码分析。
result: 离线分析显示听觉闭环反馈下的解码准确率显著低于开环基准，且受试者主观感受该反馈更具干扰性并增加了注意力切换的难度。
conclusion: 单次实验中的听觉神经反馈可能因增加认知负荷而损害AAD性能，实现有益的反馈效果需要更精确稳定的解码器及长期的多session训练协议。
---
