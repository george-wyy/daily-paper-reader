---
title: Neural Dynamics of Belief and Value Computations Guiding Strategic Social Decisions
title_zh: 引导策略性社会决策的信念与价值计算的神经动力学
authors: "Konovalov, A., Hu, J., Ruff, C. C."
date: 2026-05-12
pdf: "https://www.biorxiv.org/content/10.64898/2026.05.08.723744v1.full.pdf"
tags: ["query:gaze-intent"]
score: 6.0
evidence: 关于对手意图信念的计算模型
tldr: 本研究探讨了竞争性策略决策中的神经机制。通过结合动态学习与选择的计算模型，分析了人类在策略任务中的行为。利用脑电图（EEG）技术，研究揭示了支持信念更新及价值比较的神经处理阶段，并发现脑区间的伽马频段耦合与胜率相关，为策略行为的计算模型提供了神经层面的验证。
source: biorxiv
selection_source: fresh_fetch
motivation: 旨在揭示复杂策略背景下，指导人类学习和选择的信念与价值计算的神经机制。
method: 结合动态学习与选择机制的计算模型，并利用脑电图（EEG）记录参与者在竞争性策略任务中的神经活动。
result: 识别出了对应于信念更新和证据积累的阶段性神经处理过程，并发现特定脑区间的伽马频段耦合与个体胜率显著相关。
conclusion: 研究刻画了策略选择背后的信念与估值过程的神经动力学特征，为策略行为的计算模型假设提供了神经科学证据。
---

## 摘要
成功的策略行为必须建立在对对手及其意图的信念基础之上。虽然已有许多潜在模型被提出用于解释此类情境下的选择，但在复杂的策略背景下，主导学习和选择的神经机制仍不为人所知。在本研究中，我们使用了一个结合动态学习和选择机制的计算模型，来解释参与竞争性策略任务的人类受试者的选择和反应时间。利用脑电图（EEG），我们识别出了支持不断演化的基于价值的决策过程的、具有时间结构化的神经处理阶段，这些阶段对应于一阶和二阶信念更新，以及与动作价值比较相关的证据积累。中央区和顶叶 EEG 信号之间的伽马频段相位耦合随个人胜率而变化，这表明策略行为涉及空间上遥远区域之间的协调信息传递。总之，我们的数据刻画了构成策略选择基础的信念和估值过程随时间演变的神经动力学，并为该行为计算模型中嵌入的假设提供了神经科学验证。
